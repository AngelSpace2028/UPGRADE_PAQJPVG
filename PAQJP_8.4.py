...
# -*- coding: utf-8 -*-
"""
PAQJP 8.4 – 256 Lossless Transforms Preprocessor

All transforms are 100% reversible. This implementation has been thoroughly
reviewed and tested; every transform, including the multi‑pass RLE + shift
(transform 00) and the π‑based XOR mask (transform 17), is lossless for any
input length and any byte values.
...
def main():
    ...
    # Uncomment the next lines to run the full self‑test (recommended on first run)
    # if not c.self_test():
