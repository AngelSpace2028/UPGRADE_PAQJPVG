...
# -*- coding: utf-8 -*-
"""
PAQJP 9.1 – Transform65535 : 0‑65535 Transformation Check
==========================================================
...
Usage:
    python paqjp91_transform65535_check.py
"""
...
PROGNAME = "PAQJP_9.1_Transform65535_Check"
...
class PAQJPCompressorTransform65535:
    ...
    def full_self_test(self) -> bool:
        print("=" * 60)
        print("PAQJP 9.1 – Transform65535 CHECK (0‑65535)")
        print("=" * 60)
        test_byte = 0xAA
...
def main():
    print(f"{PROGNAME}")
    print("PAQJP 9.1 – 256 single + 65535 pairs = 65536 transform paths (indices 0‑65535)")
