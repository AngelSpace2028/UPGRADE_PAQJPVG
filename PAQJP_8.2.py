...
# -*- coding: utf-8 -*-
"""
PAQJP 8.2 – Fully Automatic Hybrid Compressor (True 64-bit Edition)
...
PROGNAME = "PAQJP_8.2_TRUE_64BIT_HYBRID"
...
class PAQJPCompressor:
    ...
    # ==================== TRUE 64-BIT BLOCK TRANSFORMS (1,2,4,8) ====================
...
# ========================= Main =========================
def main():
    print(f"{PROGNAME} – True 64-bit block transforms (1,2,4,8 bits, 8000 rounds)")
